...
namespace DeltaEngine.Multimedia.AviVideo
{
	public class AviInterop
	{
		...
		public static extern int AVIFileOpen(ref int filePtr, String szFile, int uMode,
			int pclsidHandler);

		[DllImport("avifil32.dll")]
		public static extern int AVIFileGetStream(int filePtr, out IntPtr streamPtr, int fccType,
			int lParam);

		[DllImport("avifil32.dll", PreserveSig = true)]
		public static extern int AVIStreamStart(IntPtr streamPtr);

		[DllImport("avifil32.dll", PreserveSig = true)]
		public static extern int AVIStreamLength(IntPtr streamPtr);

		[DllImport("avifil32.dll")]
		public static extern int AVIStreamInfo(IntPtr streamPtr, ref StreamInfo psi, int lSize);

		[DllImport("avifil32.dll")]
		public static extern int AVIStreamGetFrameOpen(IntPtr streamPtr, ref BitmapInfoHeader bih);

		[DllImport("avifil32.dll")]
		public static extern int AVIStreamGetFrame(int pGetFrameObj, int lPos);

		[DllImport("avifil32.dll")]
		public static extern int AVIStreamReadFormat(IntPtr streamPtr, int lPos,
		...
		[DllImport("avifil32.dll")]
		public static extern int AVIStreamRelease(IntPtr streamPtr);

		[DllImport("avifil32.dll")]
		public static extern int AVIFileRelease(int filePtr);

		[DllImport("avifil32.dll")]
		public static extern void AVIFileExit();

		[DllImport("avifil32.dll")]
		public static extern int AVIStreamRead(IntPtr streamPtr, int lStart, int lSamples,
