...
namespace DeltaEngine.Input.SlimDX
{
	...
	internal static class KeyboardKeyMapper
	{
		...
		private static void AddSpecialKeys()
		{
			...
			KeyMap.Add(DInput.Key.CapsLock, Key.CapsLock);
		...
		{
			KeyMap.Add(DInput.Key.NumberPadStar, Key.Multiply);
			KeyMap.Add(DInput.Key.NumberPadPlus, Key.Add);
			KeyMap.Add(DInput.Key.Minus, Key.Minus);
			KeyMap.Add(DInput.Key.NumberPadMinus, Key.Subtract);
			KeyMap.Add(DInput.Key.NumberPadComma, Key.Decimal);
			KeyMap.Add(DInput.Key.NumberPadSlash, Key.Divide);
		}
		...
		{
			KeyMap.Add(DInput.Key.LeftArrow, Key.CursorLeft);
			KeyMap.Add(DInput.Key.UpArrow, Key.CursorUp);
			KeyMap.Add(DInput.Key.RightArrow, Key.CursorRight);
			KeyMap.Add(DInput.Key.DownArrow, Key.CursorDown);
		}
