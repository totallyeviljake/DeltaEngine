...
namespace Blocks.Tests
{
	...
	public class GameTests : TestWithAllFrameworks
	{
		...
		{
			Start(typeof(MockResolver), (ScreenSpace screenSpace, Game game, JewelBlocksContent content) =>
			{
		...
		private void InitializeBlocks(ScreenSpace screenSpace, Controller controller, JewelBlocksContent content)
		{
			Initialize(screenSpace);
