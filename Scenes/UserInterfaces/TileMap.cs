...
//		{
//			tile.DrawArea = GetTileDrawArea(tile.TileCoord);
//			tile.Visibility = drawArea.Contains(tile.DrawArea.Center)
...
//					tile.Visibility = Visibility == Visibility.Show &&
//						drawArea.Contains(tile.DrawArea.Center) ? Visibility.Show : Visibility.Hide;
//			}
//		}
...
//		{
//			get { return Tiles[0, 0].RenderLayer; }
//			set
//			{
//				foreach (Tile tile in Tiles)
//					tile.RenderLayer = value;
//			}
//		}
