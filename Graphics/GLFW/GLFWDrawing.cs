...
{
	public sealed class GLFWDrawing : Drawing
	{
		public GLFWDrawing(Device device) : base(device)
		{
			InitializeBuffers();
		...
		private GLFWCircularBuffer<VertexPositionColor> positionColorBuffer;
		private GLFWCircularBuffer<VertexPositionColorTextured> positionColorUvBuffer;
		private GLFWCircularBuffer<short> indexBuffer;
		...
		{
			positionColorBuffer = new GLFWCircularBuffer<VertexPositionColor>(VertexBufferSize);
			positionColorUvBuffer = new GLFWCircularBuffer<VertexPositionColorTextured>(VertexBufferSize);
			indexBuffer = new GLFWCircularBuffer<short>(IndexBufferSize);
		}
		...
		public override void EnableTexturing(Image image)
		{
			...
			GL.BindTexture(TextureTarget.Texture2D, (image as GLFWImage).Handle);
		}
