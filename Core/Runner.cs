...
{
	/// <summary>
	/// Allows classes to automatically run before any app code each frame (clearing, update logic,
	/// actors, physics, etc.). Runners are executed in threads based on constructor dependencies.
